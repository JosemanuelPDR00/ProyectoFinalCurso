...
<body>
    <div class="contenedorGeneral">
        <div class="imagenRelleno imagenRellenoLogin"></div>
            ...
            <div class="zonaFormulario">
                <form action="./comprueba_login.php" method="post" class="formulario">
                    <div class="contenedorAcogedor">
                        ...
                        <input type="text" name="usuario" id="usuario" placeholder="USUARIO" class="input"><br>
                        <input type="password" name="contra" id="contra" placeholder="CONTRASEÑA" class="input">
