...
?>
        ...
        <div class="contenedorContenido">
            ...
            <div class="contenedorIBM">
                <form action="./rapidapi.php" method="get" class="formularioIBM">
                    <h4 id="tituloIBM">Indice de Masa Corporal</h4>
                    <p>Peso:</p>
                    <input type="text" name="peso" id="pesoIBM" pattern="[0-9]{1,3}(\,[0-9]{1,2})?">
                    <p>Altura:</p>
                    <input type="text" name="altura" id="alturaIBM" pattern="[0-9]{1,3}(\,[0-9]{1,2})?">
                    <input type="submit" value="Enviar" class="botonCalculoAJAX">
                </form>
                <?php
